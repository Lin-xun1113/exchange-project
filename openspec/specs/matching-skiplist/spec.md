...
The matching engine uses a skip list data structure for O(log n) price-level indexing in the order book. The skip list provides fast insertion, deletion, search, and ordered traversal of price levels, replacing sorted slice operations.
